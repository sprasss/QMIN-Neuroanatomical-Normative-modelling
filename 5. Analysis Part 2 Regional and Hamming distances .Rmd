...
```{r}
# maximum number of outliers
df_ct$diagnosis <- as.factor(df_ct$diagnosis)
roi_with_most_outliers <- df_ct %>% filter(diagnosis == "AD") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_ct %>% filter(diagnosis == "AD"))
print(diagnosis_size)

z <- df_ct %>% filter(diagnosis == "AD") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_ct %>% filter(diagnosis == "AD") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 

d <- df_ct %>% filter(diagnosis == "AD") 
median(d$tOC)
range(d$tOC)
```
...
```{r}
# maximum number of outliers
df_sv$diagnosis <- as.factor(df_sv$diagnosis)
roi_with_most_outliers <- df_sv %>% filter(diagnosis == "AD") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_sv %>% filter(diagnosis == "AD"))
print(diagnosis_size)

z <- df_sv %>% filter(diagnosis == "AD") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_sv %>% filter(diagnosis == "AD") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 

d <- df_sv %>% filter(diagnosis == "AD") 
median(d$tOC)
range(d$tOC)
...
```{r}
# maximum number of outliers
roi_with_most_outliers <- df_ct %>% filter(diagnosis == "MCI") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_ct %>% filter(diagnosis == "MCI"))
print(diagnosis_size)

z <- df_ct %>% filter(diagnosis == "MCI") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_ct %>% filter(diagnosis == "MCI") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 

d <- df_ct %>% filter(diagnosis == "MCI") 
median(d$tOC)
range(d$tOC)
...
```{r}
# maximum number of outliers
roi_with_most_outliers <- df_sv %>% filter(diagnosis == "MCI") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_sv %>% filter(diagnosis == "MCI"))
print(diagnosis_size)

z <- df_sv %>% filter(diagnosis == "MCI") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_sv %>% filter(diagnosis == "MCI") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 

d <- df_sv %>% filter(diagnosis == "MCI") 
median(d$tOC)
range(d$tOC)
...
```{r}
# maximum number of outliers
roi_with_most_outliers <- df_ct %>% filter(diagnosis == "Frontotemporal dementia") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_ct %>% filter(diagnosis == "Frontotemporal dementia"))
print(diagnosis_size)

z <- df_ct %>% filter(diagnosis == "Frontotemporal dementia") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_ct %>% filter(diagnosis == "Frontotemporal dementia") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 

d <- df_ct %>% filter(diagnosis == "Frontotemporal dementia") 
median(d$tOC)
range(d$tOC)
```
...
```{r}
# maximum number of outliers
roi_with_most_outliers <- df_sv %>% filter(diagnosis == "Frontotemporal dementia") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_sv %>% filter(diagnosis == "Frontotemporal dementia"))
print(diagnosis_size)

z <- df_sv %>% filter(diagnosis == "Frontotemporal dementia") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_sv %>% filter(diagnosis == "Frontotemporal dementia") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 

d <- df_sv %>% filter(diagnosis == "Frontotemporal dementia") 
median(d$tOC)
range(d$tOC)
...
```{r}
# maximum number of outliers
roi_with_most_outliers <- df_ct %>% filter(diagnosis == "Mixed dementia (AD and vascular dementia)") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_ct %>% filter(diagnosis == "Mixed dementia (AD and vascular dementia)"))
print(diagnosis_size)

z <- df_ct %>% filter(diagnosis == "Mixed dementia (AD and vascular dementia)") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_ct %>% filter(diagnosis == "Mixed dementia (AD and vascular dementia)") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 
...
```{r}
# maximum number of outliers
roi_with_most_outliers <- df_sv %>% filter(diagnosis == "Mixed dementia (AD and vascular dementia)") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_sv %>% filter(diagnosis == "Mixed dementia (AD and vascular dementia)"))
print(diagnosis_size)

z <- df_sv %>% filter(diagnosis == "Mixed dementia (AD and vascular dementia)") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_sv %>% filter(diagnosis == "Mixed dementia (AD and vascular dementia)") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 
...
```{r}
# maximum number of outliers
roi_with_most_outliers <- df_ct %>% filter(diagnosis == "Other non-AD Dementias") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_ct %>% filter(diagnosis == "Other non-AD Dementias"))
print(diagnosis_size)

z <- df_ct %>% filter(diagnosis == "Other non-AD Dementias") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_ct %>% filter(diagnosis == "Other non-AD Dementias") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 

d <- df_ct %>% filter(diagnosis == "Other non-AD Dementias") 
median(d$tOC)
range(d$tOC)
...
```{r}
# maximum number of outliers
roi_with_most_outliers <- df_sv %>% filter(diagnosis == "Other non-AD Dementias") %>%
  select(contains("_bin")) %>%
  colSums() %>%
  max()

diagnosis_size <- count(df_sv %>% filter(diagnosis == "Other non-AD Dementias"))
print(diagnosis_size)

z <- df_sv %>% filter(diagnosis == "Other non-AD Dementias") %>%
  select(contains("_bin")) %>%
  colSums()
length(which(z > 0))
...
df_sv %>% filter(diagnosis == "Other non-AD Dementias") %>%
  select(contains("tOC")) %>%
  colSums() %>%
  median() 

d <- df_sv %>% filter(diagnosis == "Other non-AD Dementias") 
median(d$tOC)
range(d$tOC)
